...
mrb_GLib_GScannerConfig_get_cset_skip_characters(mrb_state* mrb, mrb_value self) {
  ...
  mrb_value cset_skip_characters = mrb_str_new(mrb, native_cset_skip_characters, native_cset_skip_characters_len);
...
mrb_GLib_GScannerConfig_set_cset_skip_characters(mrb_state* mrb, mrb_value self) {
  ...
  mrb_int cset_skip_characters_len = 0;

  mrb_get_args(mrb, "s!", &cset_skip_characters, &cset_skip_characters_len);
...
mrb_GLib_GScannerConfig_get_cset_identifier_first(mrb_state* mrb, mrb_value self) {
  ...
  mrb_value cset_identifier_first = mrb_str_new(mrb, native_cset_identifier_first, native_cset_identifier_first_len);
...
mrb_GLib_GScannerConfig_set_cset_identifier_first(mrb_state* mrb, mrb_value self) {
  ...
  mrb_int cset_identifier_first_len = 0;

  mrb_get_args(mrb, "s!", &cset_identifier_first, &cset_identifier_first_len);
...
mrb_GLib_GScannerConfig_get_cset_identifier_nth(mrb_state* mrb, mrb_value self) {
  ...
  mrb_value cset_identifier_nth = mrb_str_new(mrb, native_cset_identifier_nth, native_cset_identifier_nth_len);
...
mrb_GLib_GScannerConfig_set_cset_identifier_nth(mrb_state* mrb, mrb_value self) {
  ...
  mrb_int cset_identifier_nth_len = 0;

  mrb_get_args(mrb, "s!", &cset_identifier_nth, &cset_identifier_nth_len);
...
mrb_GLib_GScannerConfig_get_cpair_comment_single(mrb_state* mrb, mrb_value self) {
  ...
  mrb_value cpair_comment_single = mrb_str_new(mrb, native_cpair_comment_single, native_cpair_comment_single_len);
...
mrb_GLib_GScannerConfig_set_cpair_comment_single(mrb_state* mrb, mrb_value self) {
  ...
  mrb_int cpair_comment_single_len = 0;

  mrb_get_args(mrb, "s!", &cpair_comment_single, &cpair_comment_single_len);
