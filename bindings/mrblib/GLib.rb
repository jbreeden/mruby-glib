module GLib
  ...
  module Gbsearcharrayflags
    G_BSEARCH_ARRAY_ALIGN_POWER2 = 1
    G_BSEARCH_ARRAY_AUTO_SHRINK = 2
  end
  ...
  module ArgType
    ...
    TYPE_STRING = 12
    TYPE_POINTER = 13
    TYPE_COUNT_SCHAR_POINTER = 14
    TYPE_COUNT_SHORT_POINTER = 15
    TYPE_COUNT_INT_POINTER = 16
    TYPE_COUNT_LONGINT_POINTER = 17
  end
end
