...
CTypes.set_macro_type('G_KEY_FILE_ERROR', CTypes['int'])
...
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_TYPE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_IS_HIDDEN', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_IS_BACKUP', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_IS_SYMLINK', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_IS_VIRTUAL', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_IS_VOLATILE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_NAME', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_DISPLAY_NAME', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_EDIT_NAME', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_COPY_NAME', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_DESCRIPTION', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_ICON', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_SYMBOLIC_ICON', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_CONTENT_TYPE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_FAST_CONTENT_TYPE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_SIZE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_ALLOCATED_SIZE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_SYMLINK_TARGET', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_TARGET_URI', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_STANDARD_SORT_ORDER', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_ETAG_VALUE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_ID_FILE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_ID_FILESYSTEM', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_ACCESS_CAN_READ', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_ACCESS_CAN_WRITE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_ACCESS_CAN_EXECUTE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_ACCESS_CAN_DELETE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_ACCESS_CAN_TRASH', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_ACCESS_CAN_RENAME', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_CAN_MOUNT', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_CAN_UNMOUNT', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_CAN_EJECT', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_UNIX_DEVICE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_UNIX_DEVICE_FILE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_HAL_UDI', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_CAN_START', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_CAN_START_DEGRADED', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_CAN_STOP', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_START_STOP_TYPE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_CAN_POLL', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_MOUNTABLE_IS_MEDIA_CHECK_AUTOMATIC', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TIME_MODIFIED', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TIME_MODIFIED_USEC', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TIME_ACCESS', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TIME_ACCESS_USEC', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TIME_CHANGED', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TIME_CHANGED_USEC', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TIME_CREATED', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TIME_CREATED_USEC', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_DEVICE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_INODE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_MODE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_NLINK', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_UID', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_GID', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_RDEV', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_BLOCK_SIZE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_BLOCKS', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_UNIX_IS_MOUNTPOINT', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_DOS_IS_ARCHIVE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_DOS_IS_SYSTEM', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_OWNER_USER', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_OWNER_USER_REAL', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_OWNER_GROUP', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_THUMBNAIL_PATH', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_THUMBNAILING_FAILED', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_THUMBNAIL_IS_VALID', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_PREVIEW_ICON', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_FILESYSTEM_SIZE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_FILESYSTEM_FREE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_FILESYSTEM_USED', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_FILESYSTEM_TYPE', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_FILESYSTEM_READONLY', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_FILESYSTEM_USE_PREVIEW', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_GVFS_BACKEND', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_SELINUX_CONTEXT', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TRASH_ITEM_COUNT', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TRASH_ORIG_PATH', CTypes['const char *'])
CTypes.set_macro_type('G_FILE_ATTRIBUTE_TRASH_DELETION_DATE', CTypes['const char *'])
