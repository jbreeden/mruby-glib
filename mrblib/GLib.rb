module GLib
  ...
  module GDBusMessageHeaderField
  ...
  module GDriveStartFlags
    G_DRIVE_START_NONE = 0
  end

  module GDriveStartStopType
  ...
  module GTlsCertificateRequestFlags
    G_TLS_CERTIFICATE_REQUEST_NONE = 0
  end

  module GTlsDatabaseLookupFlags
    G_TLS_DATABASE_LOOKUP_NONE = 0
    G_TLS_DATABASE_LOOKUP_KEYPAIR = 1
  end

  module GTlsDatabaseVerifyFlags
